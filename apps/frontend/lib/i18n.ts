...
export const labels = {
  en: {
    ...
    home: {
      ...
      name: "Jorge Borrego",
      slogan: "Fighting to lower costs, cut property taxes, keep violent criminals off our streets, and protect kids from fentanyl.",
      summary:
        "Jorge Borrego is running to give every family in House District 118 a fair shot to get ahead. Rooted in faith, family, and service, Jorge will bring working-class Republican leadership to Austin, focused on affordability, safe neighborhoods, protecting children, fair competition for girls, and rewarding the educators who serve our students.",
      primaryCta: "Donate",
      ...
      meetBody: [
        ...
        "Now, as a husband, father, small business owner, and Republican candidate for State Representative, Jorge is running to protect the promise that changed his life. He believes Texas should be a place where work is rewarded, families are safe, schools are strong, and every child has a real chance to rise. In Austin, Jorge will fight to lower the cost of living, cut property taxes, keep violent criminals off our streets, protect children from fentanyl, protect girls' sports, and raise pay for public school teachers and support staff."
      ],
      learnMore: "Learn More",
      prioritiesHeading: "Priorities",
      choiceHeading: "The Choice in This Race",
      choiceBody: [
        "Jorge Borrego is running to put families across House District 118 first: lower costs, cut property taxes, keep violent criminals off our streets, protect children from fentanyl, protect girls' sports, and raise teacher pay.",
        "This race will draw political money and pressure from outside the district. Jorge will answer to the families of House District 118, not Austin insiders or political operatives."
      ],
      donateHeadline: "Help Jorge fight for lower costs, safer streets, children protected from fentanyl, fair girls' sports, and better pay for educators.",
  ...
  es: {
    ...
    home: {
      ...
      name: "Jorge Borrego",
      slogan: "Luchando para bajar los costos, reducir los impuestos a la propiedad, sacar a los criminales violentos de nuestras calles y proteger a nuestros hijos del fentanilo.",
      summary:
        "Jorge Borrego está luchando para que cada familia del Distrito 118 tenga una oportunidad justa de salir adelante. Con raíces en la fe, la familia y el servicio, Jorge llevará a Austin un liderazgo Republicano de familias trabajadoras, enfocado en el costo de vida, vecindarios seguros, proteger a nuestros hijos, competencia justa para las niñas y mejor sueldo para quienes educan a nuestros estudiantes.",
      primaryCta: "Donar",
      ...
      meetBody: [
        ...
        "Hoy, como esposo, padre, dueño de un negocio propio y candidato Republicano para Representante Estatal, Jorge se postula para proteger la promesa que cambió su vida. Cree que Texas debe ser un lugar donde el trabajo se recompensa, las familias están seguras, las escuelas son fuertes y cada niño tiene una oportunidad real de salir adelante. En Austin, Jorge luchará para bajar el costo de vida, reducir los impuestos a la propiedad, sacar a los criminales violentos de nuestras calles, proteger a nuestros hijos del fentanilo, proteger los deportes femeninos y aumentar el sueldo de maestros y personal de apoyo de las escuelas públicas."
      ],
      learnMore: "Conoce Más",
      prioritiesHeading: "Prioridades",
      choiceHeading: "La Decisión en Esta Elección",
      choiceBody: [
        "Jorge Borrego está luchando para poner primero a las familias del Distrito 118: bajar los costos, reducir los impuestos a la propiedad, sacar a los criminales violentos de nuestras calles, proteger a nuestros hijos del fentanilo, proteger los deportes femeninos y aumentar el sueldo de los maestros.",
        "Esta elección atraerá dinero político y presiones de fuera del distrito. Jorge responderá a las familias del Distrito 118, no a los intereses de Austin ni a los operadores políticos."
      ],
      donateHeadline: "Ayuda a Jorge a luchar por costos más bajos, calles más seguras, niños protegidos del fentanilo, deportes femeninos justos y mejor sueldo para nuestros educadores.",
